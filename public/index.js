...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _models_sprite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/sprite */ \"./src/js/models/sprite.js\");\n/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./consts */ \"./src/js/etcs/consts.js\");\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\n  rand: function (min, max) {\n    return Math.floor(Math.random() * (max - min + 1)) + min;\n  },\n  killOuterField: function (char) {\n    if (char.x < 0 || char.x >> 8 > _consts__WEBPACK_IMPORTED_MODULE_1__.default.FIELD_W || char.y < 0 || char.y >> 8 > _consts__WEBPACK_IMPORTED_MODULE_1__.default.FIELD_H) {\n      char.kill = true;\n    }\n  },\n  checkCollision: function (bullet, target, targetSpriteNum) {\n    let br = _models_sprite__WEBPACK_IMPORTED_MODULE_0__.default.Sprites[bullet.spriteNum].r;\n    let tr = _models_sprite__WEBPACK_IMPORTED_MODULE_0__.default.Sprites[targetSpriteNum].r;\n    let dx = bullet.x - target.x >> 8;\n    let dy = bullet.y - target.y >> 8;\n    return Math.pow(br, 2) + Math.pow(tr, 2) > Math.pow(dx, 2) + Math.pow(dy, 2);\n  },\n\n  drawText(text, yFromCenter) {\n    _consts__WEBPACK_IMPORTED_MODULE_1__.default.con.font = '20px \"Inpact\"';\n    _consts__WEBPACK_IMPORTED_MODULE_1__.default.con.fillStyle = 'white';\n    let w = _consts__WEBPACK_IMPORTED_MODULE_1__.default.con.measureText(text).width;\n    let x = _consts__WEBPACK_IMPORTED_MODULE_1__.default.CANVAS_W / 2 - w / 2;\n    let y = _consts__WEBPACK_IMPORTED_MODULE_1__.default.CANVAS_H / 2 + yFromCenter;\n    _consts__WEBPACK_IMPORTED_MODULE_1__.default.con.fillText(text, x, y);\n  }\n\n});\n\n//# sourceURL=webpack://shooting/./src/js/etcs/functions.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _sprite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sprite */ \"./src/js/models/sprite.js\");\n/* harmony import */ var _etcs_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../etcs/functions */ \"./src/js/etcs/functions.js\");\n/* harmony import */ var _etcs_vars__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../etcs/vars */ \"./src/js/etcs/vars.js\");\n\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class {\n  constructor(x, y, vx, vy) {\n    this.x = x;\n    this.y = y;\n    this.vx = vx;\n    this.vy = vy;\n    this.kill = false;\n    this.spriteNum = 5;\n  }\n\n  update() {\n    this.x += this.vx;\n    this.y += this.vy;\n    _etcs_functions__WEBPACK_IMPORTED_MODULE_1__.default.killOuterField(this); // 当たり判定\n\n    _etcs_vars__WEBPACK_IMPORTED_MODULE_2__.default.field.enemies.forEach(enemy => {\n      if (_etcs_functions__WEBPACK_IMPORTED_MODULE_1__.default.checkCollision(this, enemy, enemy.enemyType.spriteNum())) {\n        this.kill = true;\n        enemy.kill = true;\n        _etcs_vars__WEBPACK_IMPORTED_MODULE_2__.default.field.jiki.score += enemy.enemyType.score();\n      }\n    });\n  }\n\n  draw() {\n    _sprite__WEBPACK_IMPORTED_MODULE_0__.default.Sprites[this.spriteNum].draw(this.x, this.y);\n  }\n\n});\n\n//# sourceURL=webpack://shooting/./src/js/models/jiki_bullet.js?");
