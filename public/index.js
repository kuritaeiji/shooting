...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _sprite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sprite */ \"./src/js/models/sprite.js\");\n/* harmony import */ var _etcs_consts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../etcs/consts */ \"./src/js/etcs/consts.js\");\n/* harmony import */ var _etcs_vars__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../etcs/vars */ \"./src/js/etcs/vars.js\");\n/* harmony import */ var _etcs_functions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../etcs/functions */ \"./src/js/etcs/functions.js\");\n\n\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class {\n  constructor(x, vy, enemyType) {\n    this.x = x;\n    this.y = 0;\n    this.vx = 0;\n    this.vy = vy;\n    this.kill = false;\n    this.enemyType = enemyType;\n    this.isFire = false;\n  }\n\n  update() {\n    // 100px以内に近づき、一度も弾発射していないなら弾発射\n    if (Math.abs(this.y - _etcs_vars__WEBPACK_IMPORTED_MODULE_2__.default.field.jiki.y) >> 8 < 100 && !this.isFire) {\n      this.fireBullet();\n    }\n\n    if (this.isFire) {\n      this.enemyType.runAway(this); // 敵の種類によって+y方向に逃げるか、-y方向に逃げるかを変える\n    } else {\n      if (this.x > _etcs_vars__WEBPACK_IMPORTED_MODULE_2__.default.field.jiki.x && -300 < this.vx) {\n        this.vx -= 30;\n      } else if (this.x < _etcs_vars__WEBPACK_IMPORTED_MODULE_2__.default.field.jiki.x && this.vx < 300) {\n        this.vx += 30;\n      }\n    }\n\n    if (this.x < 0 || this.x >> 8 > _etcs_consts__WEBPACK_IMPORTED_MODULE_1__.default.FIELD_W || this.y < 0 || this.y >> 8 > _etcs_consts__WEBPACK_IMPORTED_MODULE_1__.default.FIELD_H) {\n      this.kill = true;\n    }\n\n    this.x += this.vx;\n    this.y += this.vy;\n  }\n\n  draw() {\n    _sprite__WEBPACK_IMPORTED_MODULE_0__.default.Sprites[this.enemyType.spriteNum].draw(this.x, this.y);\n  }\n\n  fireBullet() {\n    this.isFire = true;\n    let dx = _etcs_vars__WEBPACK_IMPORTED_MODULE_2__.default.field.jiki.x - this.x;\n    let dy = _etcs_vars__WEBPACK_IMPORTED_MODULE_2__.default.field.jiki.y - this.y;\n    let radian = Math.atan2(dy, dx);\n    let randRadian = _etcs_functions__WEBPACK_IMPORTED_MODULE_3__.default.rand(0, 10) / 180 * Math.PI + radian; // max10°前後射線をずらす\n\n    let vx = Math.cos(randRadian) * 1000;\n    let vy = Math.sin(randRadian) * 1000;\n    this.enemyType.fireBullet(this, vx, vy);\n  }\n\n});\n\n//# sourceURL=webpack://shooting/./src/js/models/enemy.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _sprite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sprite */ \"./src/js/models/sprite.js\");\n/* harmony import */ var _etcs_consts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../etcs/consts */ \"./src/js/etcs/consts.js\");\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class {\n  constructor(x, y, vx, vy) {\n    this.x = x;\n    this.y = y;\n    this.vx = vx;\n    this.vy = vy;\n    this.kill = false;\n  }\n\n  update() {\n    this.x += this.vx;\n    this.y += this.vy;\n\n    if (this.y < 0 || this.x < 0 || this.x >> 8 > _etcs_consts__WEBPACK_IMPORTED_MODULE_1__.default.FIELD_W) {\n      this.kill = true;\n    }\n  }\n\n  draw() {\n    _sprite__WEBPACK_IMPORTED_MODULE_0__.default.Sprites[5].draw(this.x, this.y);\n  }\n\n});\n\n//# sourceURL=webpack://shooting/./src/js/models/jiki_bullet.js?");
